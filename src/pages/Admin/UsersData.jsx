...
//   MapPin 
// } from 'lucide-react';
// import { TourAdminContext } from '../../context/TourAdminContext'; // adjust path
...
//             onClick={getAllUsers}
//             disabled={!aToken}
//             className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition disabled:opacity-50"
//           >
//             <RefreshCw size={18} />
//             Refresh
//           </button>
...
//                 <tr>
//                   {['Photo', 'Name & Email', 'Phone', 'Gender', 'DOB', 'Address'].map((head) => (
...
//                 {[...Array(6)].map((_, i) => (
//                   <tr key={i}>
//                     <td className="px-6 py-8"><div className="h-12 w-12 bg-gray-200 rounded-full"></div></td>
//                     {[...Array(5)].map((_, j) => (
//                       <td key={j} className="px-6 py-8"><div className="h-5 bg-gray-200 rounded w-3/4"></div></td>
//                     ))}
//                   </tr>
//                 ))}
//               </tbody>
...
//             <UserCircle2 className="w-20 h-20 text-gray-300 mx-auto mb-6" />
//             <h3 className="text-2xl font-semibold text-gray-800 mb-3">No users yet</h3>
//             <p className="text-gray-600">New registrations will appear here.</p>
//           </div>
//         )}

//         {/* Main Table - Excel style, no Joined On */}
//         {allUsers && allUsers.length > 0 && (
//           <motion.div
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
...
//                           />
//                         ) : (
//                           <div className="h-12 w-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold shadow-sm">
